...
while True:
    ...
    if ch == 1:
        ...
        if ch2 == 1:
            ...
            no = int(
                input("How Many Number of Records You Want To Be Printed From The Top:")
            )
            df1 = df.loc[:, ["city", "name", "runs", "ballsFaced"]]
            print(df1.head(no))
            input("Press enter to continue...")
            ...
            n = int(
                input("How Many Number of Records You Want To Be Printed From Bottom:")
            )
            df1 = df.loc[:, ["city", "name", "runs", "ballsFaced"]]
            print(df1.tail(n))
            input("Press enter to continue...")
            ...
            sno = int(
                input("Enter The Sr.No. For Which You Want The data To Be Displayed:")
            )
            print(df.loc[sno])
            input("Press enter to continue...")
        elif ch2 == 6:
            team = input(
                "Enter The Sr.No. For Which You Want The data To Be Displayed:"
            )
